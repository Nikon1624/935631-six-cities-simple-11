        ...
        <div className="near-places__list places__list">
          <article className="near-places__card place-card">
            <div className="near-places__image-wrapper place-card__image-wrapper">
              <a href="/some">
                <img className="place-card__image" src={`${process.env.PUBLIC_URL}/img/room.jpg`} width="260" height="200" alt="Place" />
              </a>
            </div>
            <div className="place-card__info">
              ...
              <h2 className="place-card__name">
                <a href="/some">Wood and stone place</a>
              </h2>
          ...
          <article className="near-places__card place-card">
            <div className="near-places__image-wrapper place-card__image-wrapper">
              <a href="/some">
                <img className="place-card__image" src={`${process.env.PUBLIC_URL}/img/apartment-02.jpg`} width="260" height="200" alt="Place" />
              </a>
            </div>
            <div className="place-card__info">
              <div className="place-card__price-wrapper">
              ...
              <h2 className="place-card__name">
                <a href="/some">Canal View Prinsengracht</a>
              </h2>
          ...
          <article className="near-places__card place-card">
            ...
            <div className="near-places__image-wrapper place-card__image-wrapper">
              <a href="/some">
                <img className="place-card__image" src={`${process.env.PUBLIC_URL}/img/apartment-03.jpg`} width="260" height="200" alt="Place" />
              </a>
            </div>
            <div className="place-card__info">
              <div className="place-card__price-wrapper">
              ...
              <h2 className="place-card__name">
                <a href="/some">Nice, cozy, warm big bed apartment</a>
              </h2>
              <p className="place-card__type">Apartment</p>
            </div>
          </article>
